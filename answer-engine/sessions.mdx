...
<ParamField path="query" type="AskParams" required>
  Search parameters. Accepts all [SearchParams](/searching/introduction) options.
</ParamField>
...
<CardGroup cols={2}>
  ...
  <Card title="Search Parameters" icon="magnifying-glass" href="/searching/introduction">
