...
The Answer Engine requires the [Secure Proxy Plugin](/plugins/plugin-secure-proxy) to securely communicate with AI providers like OpenAI. This plugin:
...
Refer to the [Secure Proxy documentation](/plugins/plugin-secure-proxy) for a complete list of supported models.
...
- [Search API Reference](/searching/introduction)
- [Plugin System](/plugins/introduction)
- [TypeScript Support](/guides/typescript)