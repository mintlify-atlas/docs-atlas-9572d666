...
<CardGroup cols={2}>
  ...
  <Card title="Secure Proxy" icon="shield" href="/plugins/secure-proxy">
    Configure the Secure Proxy plugin
  </Card>
  <Card title="Answer Sessions" icon="comments" href="/answer-engine/sessions">
    Configure and customize answer sessions
  </Card>
  <Card title="Performance" icon="bolt" href="/guides/performance-optimization">
