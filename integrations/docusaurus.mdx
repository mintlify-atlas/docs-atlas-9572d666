...
<CardGroup cols={2}>
  <Card title="Orama Cloud" icon="cloud" href="/cloud/overview">
    Learn more about Orama Cloud features
  </Card>
  <Card title="Search Analytics" icon="chart-line" href="/cloud/analytics">
    Track and analyze search behavior
  </Card>
  <Card title="React Components" icon="react" href="/open-source/plugins/react-components">
