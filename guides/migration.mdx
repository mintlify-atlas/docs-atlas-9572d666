...
<Tip>
Answer Sessions enable ChatGPT-like experiences with your own data. See [Answer Engine documentation](/answer-engine) for details.
</Tip>
...
<CardGroup cols={2}>
  <Card title="What's New in v3" icon="star" href="/whats-new">
