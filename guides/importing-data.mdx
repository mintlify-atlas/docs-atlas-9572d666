...
<Info>
Orama supports stemming and tokenization in 30 languages. See [Text Analysis](/text-analysis) for the full list.
</Info>
...
<CardGroup cols={2}>
  <Card title="Search Your Data" icon="magnifying-glass" href="/search/fulltext">
